...
const QueueStackScreen = () => (
  <QueueStack.Navigator>
    <QueueStack.Screen name="QueueHome" component={QueueScreen} options={{ title: '접수' }} />
...
const RepairStackScreen = () => (
  <RepairStack.Navigator>
    <RepairStack.Screen name="RepairHome" component={RepairHomeScreen} options={{ title: '수리' }} />
...
const ReportStackScreen = () => (
  <ReportStack.Navigator>
    <ReportStack.Screen name="ReportHome" component={ReportScreen} options={{ title: '리포트' }} />
  </ReportStack.Navigator>
);

export const PartnersNavigator = () => {
  return (
    <RepairCasesProvider>
      <NavigationContainer>
        <Tab.Navigator
        ...
        >
          <Tab.Screen name="QueueTab" component={QueueStackScreen} options={{ title: '접수' }} />
          <Tab.Screen name="InspectionTab" component={InspectionStackScreen} options={{ title: '점검' }} />
          <Tab.Screen name="RepairTab" component={RepairStackScreen} options={{ title: '수리' }} />
          <Tab.Screen name="ReportTab" component={ReportStackScreen} options={{ title: '리포트' }} />
        </Tab.Navigator>
      </NavigationContainer>
    </RepairCasesProvider>
  );
